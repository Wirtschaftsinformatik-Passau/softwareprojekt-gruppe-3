...
class Buchung(db.Model):
    ...
    buchungsnummer = db.Column(db.String(100))
...
class Passagier(db.Model):
    ...
    ausweisnummer = db.Column(db.String(10), nullable=True)
    ...
    boardingpassnummer = db.Column(db.String(255))
...
class Rechnung(db.Model):
    ...
    rechnungsnummer = db.Column(db.String(255))
